...
const Knob: React.FC<{ remote: boolean, x: number, y: number, width: number, height: number }> = ({ remote, x, y, width, height }) => {
  ...
  return (
    ...
    >
      ...
      <Arrow dir={DIRS.UP} width={40} length={100} value={pos[1]} cx={x} cy={y} />
      <Arrow dir={DIRS.LEFT} width={40} length={100} value={pos[0]} cx={x} cy={y} />
      <Arrow dir={DIRS.DOWN} width={40} length={100} value={pos[1]} cx={x} cy={y} />
      <Arrow dir={DIRS.RIGHT} width={40} length={100} value={pos[0]} cx={x} cy={y} />
